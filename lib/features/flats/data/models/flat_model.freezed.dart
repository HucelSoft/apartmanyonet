...
@JsonKey(fromJson: parseRelationId) String get site; FlatStatus get status;/// ID of the [users] record for the flat owner (optional).
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,flat,apartment,organization,site,status,owner,contract,created,updated,deleted);

@override
String toString() {
  return 'FlatModel(id: $id, flat: $flat, apartment: $apartment, organization: $organization, site: $site, status: $status, owner: $owner, contract: $contract, created: $created, updated: $updated, deleted: $deleted)';
}
...
@useResult
$Res call({
 String id, int flat,@JsonKey(fromJson: parseRelationId) String apartment,@JsonKey(fromJson: parseRelationId) String organization,@JsonKey(fromJson: parseRelationId) String site, FlatStatus status,@JsonKey(fromJson: parseRelationIdNullable) String? owner,@JsonKey(fromJson: parseRelationIdNullable) String? contract,@JsonKey(fromJson: parsePbDate, toJson: formatPbDate) DateTime created,@JsonKey(fromJson: parsePbDate, toJson: formatPbDate) DateTime updated,@JsonKey(fromJson: parsePbDateNullable, toJson: formatPbDateNullable) DateTime? deleted
});
...
/// Create a copy of FlatModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? flat = null,Object? apartment = null,Object? organization = null,Object? site = null,Object? status = null,Object? owner = freezed,Object? contract = freezed,Object? created = null,Object? updated = null,Object? deleted = freezed,}) {
...
as FlatStatus,owner: freezed == owner ? _self.owner : owner // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _FlatModel() when $default != null:
return $default(_that.id,_that.flat,_that.apartment,_that.organization,_that.site,_that.status,_that.owner,_that.contract,_that.created,_that.updated,_that.deleted);case _:
  return orElse();
...
/// ID of the [users] record for the flat owner (optional).
...
/// Create a copy of FlatModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? flat = null,Object? apartment = null,Object? organization = null,Object? site = null,Object? status = null,Object? owner = freezed,Object? contract = freezed,Object? created = null,Object? updated = null,Object? deleted = freezed,}) {
