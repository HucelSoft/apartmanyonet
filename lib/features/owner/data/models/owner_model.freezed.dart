...
@override
String toString() {
  return 'OwnerModel(id: $id, name: $name, surname: $surname, type: $type, email: $email, phone: $phone, organization: $organization, created: $created, updated: $updated, deleted: $deleted)';
}
...
class _OwnerModel extends OwnerModel {
  const _OwnerModel({required this.id, this.name, this.surname, @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) this.type, this.email, this.phone, @JsonKey(fromJson: parseRelationIdNullable) this.organization, @JsonKey(fromJson: parsePbDate, toJson: formatPbDate) required this.created, @JsonKey(fromJson: parsePbDate, toJson: formatPbDate) required this.updated, @JsonKey(fromJson: parsePbDateNullable, toJson: formatPbDateNullable) this.deleted}): super._();
