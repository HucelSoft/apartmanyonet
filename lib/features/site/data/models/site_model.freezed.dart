...
mixin _$SiteModel {
 ...
 String get id; String get name; String? get address;/// ID of the parent [organization] record (or expanded map).
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,address,organization,created,updated,deleted);

@override
String toString() {
  return 'SiteModel(id: $id, name: $name, address: $address, organization: $organization, created: $created, updated: $updated, deleted: $deleted)';
}
...
/// Create a copy of SiteModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? address = freezed,Object? organization = null,Object? created = null,Object? updated = null,Object? deleted = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? address, @JsonKey(fromJson: parseRelationId)  String organization, @JsonKey(fromJson: parsePbDate, toJson: formatPbDate)  DateTime created, @JsonKey(fromJson: parsePbDate, toJson: formatPbDate)  DateTime updated, @JsonKey(fromJson: parsePbDateNullable, toJson: formatPbDateNullable)  DateTime? deleted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SiteModel() when $default != null:
return $default(_that.id,_that.name,_that.address,_that.organization,_that.created,_that.updated,_that.deleted);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? address, @JsonKey(fromJson: parseRelationId)  String organization, @JsonKey(fromJson: parsePbDate, toJson: formatPbDate)  DateTime created, @JsonKey(fromJson: parsePbDate, toJson: formatPbDate)  DateTime updated, @JsonKey(fromJson: parsePbDateNullable, toJson: formatPbDateNullable)  DateTime? deleted)  $default,) {final _that = this;
switch (_that) {
case _SiteModel():
return $default(_that.id,_that.name,_that.address,_that.organization,_that.created,_that.updated,_that.deleted);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? address, @JsonKey(fromJson: parseRelationId)  String organization, @JsonKey(fromJson: parsePbDate, toJson: formatPbDate)  DateTime created, @JsonKey(fromJson: parsePbDate, toJson: formatPbDate)  DateTime updated, @JsonKey(fromJson: parsePbDateNullable, toJson: formatPbDateNullable)  DateTime? deleted)?  $default,) {final _that = this;
switch (_that) {
case _SiteModel() when $default != null:
return $default(_that.id,_that.name,_that.address,_that.organization,_that.created,_that.updated,_that.deleted);case _:
  return null;
...
/// Create a copy of SiteModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? address = freezed,Object? organization = null,Object? created = null,Object? updated = null,Object? deleted = freezed,}) {
